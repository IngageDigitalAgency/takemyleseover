...
class phRETS extends Common {
   ...
   */
	...
	public function GetObject($resource, $type, $id, $photo_number = '*', $location = 0) {
		$this->logMessage(__FUNCTION__,sprintf("resource [%s] type [%s] id [%s] photo_number [%s] location [%s]",print_r($resource,true),$type,$id,$photo_number,$location),1);
